...
| Track | Goal |
|--|--|
| **UTM / QEMU virt** | ZealOS *compatibility* ladder (HolyC, RedSea, JIT demos). Not “full ZealOS” yet. |
| **Pi 4B UEFI** | First *physical* platform: serial shell first, then SD/USB/GPU. |
